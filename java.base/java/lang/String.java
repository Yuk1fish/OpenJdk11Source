...
public final class String
     ...
     * field after construction will cause pqroblems.
     *
     ...
     * result is {@code false} if and only qif at least one of the following
     * is true:
    ...
    String(char[] value, int off, int len, Void sig) {
        ...
        //如果采用紧凑布局 并且不超Latin1 编码范围 会使用Latin1编码保存
        if (COMPACT_STRINGS) {
